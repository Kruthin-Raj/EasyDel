...
export default async function NewRoutePage() {
  ...
  const [deliverable, drivers] = await Promise.all([
        ...
        <div className="max-w-3xl space-y-4">
          ...
          <Card>
            <div className="p-5">
              ...
              >
                <Field label="Route name" name="name" required placeholder="Morning Newspaper Route 01" />
                        ...
                        >
                          ...
                          <span className="text-sm">
                            ...
                            <span className="text-ink-dim">
                              {' '}— {qty} item{qty === 1 ? '' : 's'} across {l.subscriptions.length}{' '}
